...
RELATED_AXIS = { 'X' : [LELBOWYAW, LWRISTYAW, RELBOWYAW, LHIPROLL, LANKLEROLL, RHIPROLL, RANKLEROLL],
                 'Y' : [HEADPITCH, LSHOULDERPITCH, RSHOULDERPITCH, LHIPYAWPITCH, RKNEEPITCH, RANKLEPITCH],
                 'Z' : [HEADYAW, LSHOULDERROLL, LELBOWROLL, RSHOULDERROLL, RELBOWROLL, LHIPYAWPITCH, RHIPYAWPITCH]
               }
